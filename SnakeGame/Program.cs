...
namespace SnakeGame
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            { 
                Console.WriteLine("Skriv 1 for Snake, 2 for HeroGame, 3 for å lukke programmet.");
                int spillID = Convert.ToInt32(Console.ReadLine());
                if (spillID == 1)
                {
                    Snake();
                    break;
                ...
                {
                    Console.WriteLine("Vennligst oppgi ett gyldig nummer.");
                }
            }
        ...
        static void Snake()//hva skjer om du endrer dette metodenavnet?
        {
            ...
            //int delayInMillisecs = 50;
                Console.WriteLine("Select Snake speed in pure number. Recommended speed between 30 - 80.");
                int delayInMillisecs = Convert.ToInt32(Console.ReadLine());                                                                                                                                         
